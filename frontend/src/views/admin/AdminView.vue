<template>
  <div class="container container-fluid py-4">
    <div class="row">
      <div class="col col-4">
        <div class="card border-info shadow shadow-sm bg-light">
          <div class="card-body">
            <h5 class="card-title">Khách hàng <i class="fa fa-users"></i></h5>

            <p class="card-text">Quản lý thông tin khách hàng</p>

            <RouterLink to="/admin/customers" class="btn btn-info"> Xem </RouterLink>
          </div>
        </div>
      </div>
      ...
      <div class="col col-4">
        <div class="card border-info shadow shadow-sm bg-light">
          <div class="card-body">
            ...
            <RouterLink to="/admin/products" class="btn btn-info"> Xem </RouterLink>
          </div>
        </div>
      </div>
      ...
      <div class="col col-4">
        <div class="card border-info shadow shadow-sm bg-light">
          <div class="card-body">
            ...
            <RouterLink to="/admin/invoices" class="btn btn-info text-center"> Xem </RouterLink>
          </div>
        </div>
      </div>
    </div>
